...
Param(
  ...
  [bool] $NoAuth = $false,
  [string] $SkippedColumns = $SkippedColumns
)
...
try
{
	Prepare-Table $db $DBFile $TableName $SkippedColumns
}
finally
{
	$db.Close()
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUghmecFLdcutby2GUaFf6UtS1
# vF6gggo0MIIE0zCCA7ugAwIBAgIQXJkusQrBtsaXJ/F/dxsW+DANBgkqhkiG9w0B
...
# hkiG9w0BCQQxFgQU7wCE+E/T6baVWDPw1pfSlwDjk8IwDQYJKoZIhvcNAQEBBQAE
# ggEAOgDn9vZgZMnCJ1HvIYagFh09c4Wh6zWr3xAKgsPssyxwv6nbkg2LvY4pykcd
# Za8sYiyQith+8JX4LMJ5kbBwDwSqEgJCunE7AnW+Y9AricaorGZr1+KV2PAHbEpW
# uimcAXsJlxVEJRZFFu0XQPvQrw/JJv5qtv0ZmoYyxwr6f/RnemHEZWjPyPBvNfd/
# 0notLlSA3lFx9uZmheZSkoTD9K1MbbK8UJO0gFEs7lgIy3o8z6NNmODp50K80ftk
# mlD5tCB+4Km3h3Ey+ucEcRGsNa1lKgvqwr+Sjd2L39Qf7/7X17Az1DNF/kAABIlS
# 5WuFcrvak/gQwODF939cGFQXUg==
